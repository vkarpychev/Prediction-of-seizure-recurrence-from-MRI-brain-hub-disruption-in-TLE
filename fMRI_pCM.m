...
maindir = pwd;
id = strfind(maindir,'/');
datadir = [maindir(1:id(end) - 6),'/Data','/ImageDatabase_BIDS','/Patients','/derivatives','/TS','/HCP_MMP1_DK'];
% defining time-series data
TS = dir([datadir,'/*TC_cell_prediction.mat']);
...
save([maindir(1:id(end) - 6),'/Data','/ImageDatabase_BIDS','/Patients','/derivatives',...
                             '/TS','/HCP_MMP1_DK','/HCP_MMP1_DK_FC_matrix_prediction.mat'],'group_mat');
